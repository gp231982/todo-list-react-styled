    ...
    <Section
      ...
      extraHeaderContent={
        <p style={{ padding: "30px" }}>
          ...
          nie poddaję sie i mam nadzieję, że uda mi się dopiąc swego i zostać
          programistą ;) 
          <br/><br/>Tymczasem cieszę się z ukończenia tego zadania, bo kolejny mały kroczek na drodze do sukcesu 😎🎈🎈
